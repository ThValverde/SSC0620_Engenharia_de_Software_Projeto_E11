...
sequenceDiagram 
    ...
    alt FA1, FA2, FA3: Dados localizados com sucesso 
    ...
    else FE1: Ausência de Dados no Período 
    ...
    else FE2: Erro no Processamento / Banco Indisponível 
        B->>DB: Executa Query ORM 
        DB--xB: Falha de conexão / Instabilidade 
